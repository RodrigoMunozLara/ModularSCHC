...
SCHCArqFecReceiver_WAIT_X_MISSING_FRAGS::SCHCArqFecReceiver_WAIT_X_MISSING_FRAGS(SCHCArqFecReceiver& ctx): _ctx(ctx)
{

}

SCHCArqFecReceiver_WAIT_X_MISSING_FRAGS::~SCHCArqFecReceiver_WAIT_X_MISSING_FRAGS()
{
    SPDLOG_DEBUG("Executing SCHCArqFecReceiver_WAIT_X_MISSING_FRAGS destructor()");
}
...
void SCHCArqFecReceiver_WAIT_X_MISSING_FRAGS::timerExpired()
{
}

void SCHCArqFecReceiver_WAIT_X_MISSING_FRAGS::release()
{
}

int SCHCArqFecReceiver_WAIT_X_MISSING_FRAGS::get_tile_ptr(uint8_t window, uint8_t fcn)
{
    if(window==0)
    {
...
int SCHCArqFecReceiver_WAIT_X_MISSING_FRAGS::get_bitmap_ptr(uint8_t fcn)
{
    return (_ctx._windowSize - 1) - fcn;
}
...
void SCHCArqFecReceiver_WAIT_X_MISSING_FRAGS::printMatrixHex(const std::vector<std::vector<uint8_t>>& matrix) 
{
...
bool SCHCArqFecReceiver_WAIT_X_MISSING_FRAGS::checkEnoughSymbols()
{
...
std::vector<uint8_t> SCHCArqFecReceiver_WAIT_X_MISSING_FRAGS::convertDmatrix_to_SCHCPacket()
{
...
uint32_t SCHCArqFecReceiver_WAIT_X_MISSING_FRAGS::calculate_crc32(const std::vector<uint8_t>& msg) 
{
...
uint8_t SCHCArqFecReceiver_WAIT_X_MISSING_FRAGS::get_c_from_bitmap(uint8_t window)
{

...
class SCHCArqFecReceiver: public ISCHCStateMachine
{
    public:
        SCHCArqFecReceiver(SCHCFragDir dir, AppConfig& appConfig, SCHCCore& schcCore, SCHCSession& schcSession);
        ~SCHCArqFecReceiver() override;
        ...
        ISCHCStack*                     _stack;
        SCHCTimer                       _timer;
        SCHCArqFecReceiverStates        _currentStateStr;
        SCHCArqFecReceiverStates        _nextStateStr;
